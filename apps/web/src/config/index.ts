...
export const announcements: Announcement[] = [
  ...
  {
    content:
      "These blog posts are analysed and generated by LLM from Gemini. There are currently some inaccuracies with the numbers from the LLM and we are working on a fix!",
    paths: ["/blog"],
  },
];
