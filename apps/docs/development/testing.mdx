...
pnpm -F @sgcarstrends/api test -- src/utils/__tests__/format-percentage.test.ts
```

```bash Pattern matching
pnpm test -- --grep "formatPercentage"
```
...
```typescript src/utils/__tests__/format-percentage.test.ts
