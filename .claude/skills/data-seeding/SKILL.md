...
```bash
pnpm -F @motormetrics/database db:seed           # Run all seeds
pnpm -F @motormetrics/database db:seed:cars      # Seed specific table
```
...
```bash
pnpm -F @motormetrics/database add -D @faker-js/faker
```
